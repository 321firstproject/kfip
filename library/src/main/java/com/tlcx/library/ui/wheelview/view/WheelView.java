...
/**
 * 滚轮选择器
 * Created by victor on 2016/10/9 10:06.
...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        mPaint.setColor(getResources().getColor(R.color.wheel_view_unselected_text));
        mPaint.setTextSize(ScreenUtils.sp2px(context, 18));

        selectPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        selectPaint.setStyle(Paint.Style.FILL);
        selectPaint.setTextAlign(Paint.Align.CENTER);
        selectPaint.setColor(getResources().getColor(R.color.wheel_view_selected_text));
        selectPaint.setTextSize(ScreenUtils.sp2px(context, 22));
        ...
        centerLinePaint.setColor(getResources().getColor(R.color.wheel_view_unselected_text));
    ...
    public void setBackground(Drawable background) {
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                centerLinePaint.setColor(getResources().getColor(R.color.wheel_view_bg));
